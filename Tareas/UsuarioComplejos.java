...
public class UsuarioComplejos {
    ...
    public static void main(String[] arg){
        ...
        TareaComplejos complejo2=new TareaComplejos();
        ...
        do{
            ...
            if (opcionRepValores!=1){
                ...
                System.out.print("Re: "); complejo1.re=input1.nextDouble();
                System.out.print("Im: "); complejo1.im=input1.nextDouble();
                //Lectura del segundo número complejo
                System.out.println("Introduzca la parte real e imaginaria del segundo número: ");
                System.out.print("Re: "); complejo2.re=input1.nextDouble();
                System.out.print("Im: "); complejo2.im=input1.nextDouble();
            }

            System.out.println("El resultado de la operación es: " + operaciones(opcionOperacion, complejo1,complejo2).toString());
            ...
            if(opcionContinuar==1){
                System.out.println("Si desea utilizar los mismos numeros complejos, presione 1; sino, presione otra tecla.");
        ...
        input1.close();
        //System.out.println("Su complejo es: "+miComplejo.toString());
    }
}
